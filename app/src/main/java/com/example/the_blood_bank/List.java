package com.example.the_blood_bank;
...
public class List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* String as = getIntent().getStringExtra("aa");
        ...
        DatabaseReference UpRef = FirebaseDatabase.getInstance().getReference().child("hospital_add").child("1");
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference dRef = FirebaseDatabase.getInstance().getReference().child("hospital_add");
                dRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild("1")){
                            Ref = FirebaseDatabase.getInstance().getReference().child("hospital_add").child("1");
                            Ref.removeValue();
