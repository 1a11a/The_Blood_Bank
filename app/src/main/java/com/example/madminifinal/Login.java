...
//import com.google.firebase.database.DataReference;
          ...
          awesomeValidation.addValidation(this,R.id.txt1,
            ...
            btn.setOnClickListener(new View.OnClickListener() {
               ...
               if(TextUtils.isEmpty(txt1.getText().toString())))
                  Toast.makeText(getApplicationContext(), "First Name is required", Toast.LENGHTH_LONG).show();

                  else if(TextUtils.isEmpty(txt2.getText().toString()))
                  Toast.makeText(getApplicationContext(), "Password is requierd", Toast.LENGTH.LONG).show();
